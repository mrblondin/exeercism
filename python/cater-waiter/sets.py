...
def check_drinks(drink_name, drink_ingredients):
    ...
    return drink_name + (" Cocktail" if len(set(drink_ingredients) & ALCOHOLS) > 0
                         else " Mocktail")
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for index, item in enumerate([VEGAN, VEGETARIAN, KETO, PALEO, OMNIVORE]):
        if dish_ingredients <= item:
